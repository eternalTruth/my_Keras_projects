...
def detect_objects(image_np, sess, detection_graph):
    ...
    # 扩展维度，因为模型需要图片的形shape为[1, None, None, 3]
...
#get_ipython().magic('time white_clip.write_videofile(white_output, audio=False)')todo
...
white_clip = clip1.fl_image(process_image)  # NOTE: this function expects color images!!s
#get_ipython().magic('time white_clip.write_videofile(white_output1, audio=False)')todo
...
#get_ipython().magic('time white_clip.write_videofile(white_output2, audio=False)')todo
...
#get_ipython().magic('time white_clip.write_videofile(white_output3, audio=False)')todo
